...
func DeleteresourcepolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteResourcePolicyResult
...
func CreateDeleteresourcepolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_DeleteResourcePolicy",
		mcp.WithDescription("Deletes a resource policy from the target Amazon Web Services account."),
		mcp.WithString("PolicyName", mcp.Required(), mcp.Description("Input parameter: The name of the resource policy to delete.")),
		mcp.WithString("PolicyRevisionId", mcp.Description("Input parameter: Specifies a specific policy revision to delete. Provide a <code>PolicyRevisionId</code> to ensure an atomic delete operation. If the provided revision id does not match the latest policy revision id, an <code>InvalidPolicyRevisionIdException</code> exception is returned. ")),
	)
